<form class="modal-content" id="form-create">
    ...
    <div class="modal-header bg-light">
        <h5 class="modal-title">បន្ថែមចំណាយ</h5>
    ...
    <div class="modal-body">
                ...
                <button type="button" class="btn btn-light p-0">
                    <select name="sender" class="form-control km">
                        @foreach($sender as $value)
                            <option {{$value->desc==='ចំណូលថ្លៃឈ្នួល'?'selected':''}} value="{{$value->id}}">{{$value->desc}} : ({{$value->balance}})</option>
                        @endforeach
                    </select>
                </button>
        ...
        <table class="table table-striped table-sm">
            ...
            <tr>
                ...
                <td>
                    <input type="text" placeholder="ពិពណ៌នា" name="expense[0][desc]"
                           class="form-control ac-basic ui-autocomplete-input" autocomplete="off">
                </td>
                <td>
                    <input name="expense[0][balance]" id="qty" type="number" min="0" step="any"
            ...
            <tr>
                ...
                <td></td>
                <td>
                    <a href="#" id="product-add-row-expense" class="badge badge-info"><i class="icon-add"></i></a>
                </td>
            </tr>
            </tfoot>
        </table>
    ...
    <div class="modal-footer bg-light">
        ...
        <button type="button" id="expense-store" class="btn bg-success">រក្សារទុក</button>
    </div>
</form>