<form class="modal-content" id="form-create">
    ...
    <div class="modal-header bg-light">
        <h5 class="modal-title">ជំពាក់គេ</h5>
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            <label class="col-md-2">វិក័យបត្រទិញ</label>
            <div class="col-md-10">
                <select name="stock_invoice" class="form-control km">
                    @foreach($stock as $value)
                        <option value="{{$value->id}}">ID: {{$value->id}} តម្លៃទិញ: {{$value->pur_value}} កាលបរិច្ឆេទ: {{$value->created_at}}</option>
                    @endforeach
                </select>
            </div>
        </div>
    ...
    <div class="modal-footer bg-light">
        ...
        <button type="button" id="ap-store" class="btn bg-success">រក្សារទុក</button>
    </div>
</form>