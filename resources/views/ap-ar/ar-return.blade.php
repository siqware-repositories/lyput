<form class="modal-content" id="form-create">
    ...
    <div class="modal-body">
        ...
        <table class="table table-bordered table-striped table-sm">
            ...
            <tr>
                <td>
                    <input readonly type="number" class="form-control due" value="{{$account_receivable->balance}}">
                </td>
                <td>
                    <input type="number" step="any" min="0" name="balance" max="{{$account_receivable->balance}}" class="form-control payable" placeholder="សង">
                </td>
                <td>
    ...
    <div class="modal-footer bg-light">
        ...
        <button type="button" data-id="{{$account_receivable->id}}" id="ar-return-store" class="btn bg-success">រក្សារទុក</button>
    </div>
</form>