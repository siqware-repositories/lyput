...
var APARBasic = function () {
    ...
    var _componentDatatable = function () {
        ...
        table = $('.datatable-stock-inv').DataTable({
            autoWidth: true,
            processing: true,
            serverSide: true,
            ajax: {
                url: route('report.stock.invoice'),
                method: 'post'
            },
            columns: [
                {data: 'id', name: 'id'},
        ...
        _table = $('.datatable-inv').DataTable({
            autoWidth: true,
            processing: true,
            serverSide: true,
            ajax: {
...
function aparBasic() {
    ...
    /*ap invoice show*/
    $(document).on('click', '#report-stock-invoice-show', function () {
        var id = parseInt($(this).attr('data-id'));
        console.log(id);
        $.ajax({
            url: route('report.stock.invoice.show',id),
            method: 'get',
            success: function (data) {
                $('#modal-content').html(data);
            }
    ...
    /*ar invoice show*/
    $(document).on('click', '#report-invoice-show', function () {
        var id = parseInt($(this).attr('data-id'));
        $.ajax({
            url: route('report.invoice.show',id),
            method: 'get',
            success: function (data) {
                $('#modal-content').html(data);
            }
